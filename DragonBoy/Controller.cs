		...
		try
		{
			...
			case 65:
			{
				...
				if (ItemTime.isExistMessage(b67))
				{
					if (num157 != 0)
					{
						ItemTime.getMessageById(b67).initTimeText(b67, text7, num157);
					}
					else
					{
				...
				else
				{
					...
					itemTime.initTimeText(b67, text7, num157);
			...
			case -96:
			{
				...
				for (int num114 = 0; num114 < b48; num114++)
				{
			...
			case -90:
			{
				...
				@char = ((Char.myCharz().charID != num161) ? GameScr.findCharInMap(num161) : Char.myCharz());
				if (b69 != -1)
				{
			...
			case -86:
			{
				...
				if (b42 == 1)
				{
					...
					Char char6 = GameScr.findCharInMap(num106);
					if (char6 == null)
					{
						return;
					}
			...
			case 92:
			{
				...
				GameScr.info2.addInfoWithChar(empty, char7, b47 == 0);
